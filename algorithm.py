class Reasoner:
    ...
    def create_graph(self, verbose=False):
        while self.stack:
            ...
            # Get transition states and their reasons for the trace
            new_states, reasons = state.get_transitions()

            # Print state info for trace
            if verbose:
                print('\n' + '-'*80)
            ...
            for ns in new_states:
                ...
                # Add state for processing if new
                if not existing:
            ...
            # Print transition info for trace
            if verbose:
...
class State:
    ...
    def __init__(self, inflow=None, outflow=None, volume=None, prev=None):
    ...
    # Generate transitions that happen immediately
    ...
    # Generate transitions caused by dependencies (I+/I-/P+/VC)
    ...
    # Generate transitions from interval to point after a certain amount of time
    ...
    # Create a description of the state for the trace
    ...
    def __eq__(self, other):
        ...
        return self.inflow == other.inflow and self.outflow == other.outflow and self.volume == other.volume
